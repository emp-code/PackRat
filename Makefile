...
all: packrat packrat-analyzer packrat-v2reader packrat-v2_to_v3
...
packrat-v2_to_v3: Utils/v2_to_v3.c
	$(CC) $(CFLAGS) -o packrat-v2_to_v3 Utils/v2_to_v3.c Utils/packrat_v2_read.c packrat.c

.PHONY: clean
clean:
	-rm packrat packrat-analyzer packrat-v2reader packrat-v2_to_v3
